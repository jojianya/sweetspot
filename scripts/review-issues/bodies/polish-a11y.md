...
### [P3.8](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.8) useDialogFocus has no body scroll lock and no inert

- [ ] **Lock `document.body` overflow while open** — `client/src/hooks/useDialogFocus.ts`.

### [P3.10](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.10) CreatePinButton defaults categoryId to 1 before categories load
...
### [P3.12](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.12) roles/page.tsx — pointless IIFE wrapping a single button

- [ ] **Inline it** — `client/src/app/roles/page.tsx:218`.

### [P3.13](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.13) Collections links on the profile page go nowhere
