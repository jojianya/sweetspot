...
### [P3.1](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.1) Leftover debug log on every map move
...
### [P3.2](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.2) Map silently jumps to the user's location on load
...
### [P3.3](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.3) usePins duplicates useAsyncData and has no retry
...
### [P3.4](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.4) usePins leaves loading stuck true when bbox goes null
...
### [P3.5](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.5) useCollections.addPin optimistically bumps pin_count even when the pin was already present
...
### [P3.6](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.6) useSavedStatus fetches the entire favorite ID list to check one pin
...
### [P3.7](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.7) useSessionRefresh fires GET /users/:id on every page navigation
...
### [P3.16](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.16) SearchBar sets loading=false from an aborted request's finally
