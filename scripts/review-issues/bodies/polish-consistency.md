...
### [P3.9](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.9) Client caption limit (200) ≠ server limit (500)
...
### [P3.11](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.11) pin-default icon is unreachable dead code
...
### [P3.14](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.14) users/[id] uses Promise.all for profile + pins + collections
...
### [P3.15](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.15) users/[id] return null (blank screen, no Navbar)

- [ ] **Return an error UI instead of `null`** — `page.tsx:293`. Unreachable today but has no fallback.

### [P3.20](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.20) Auth is cleared on *any* 401
