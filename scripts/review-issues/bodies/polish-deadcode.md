...
### [P3.19](https://github.com/jojianya/sweetspot/blob/development/docs/CODE_REVIEW.md#p3.19) logger.FromContext(nil) reads like a bug
...
### [P3.21](https://github.com/jojianya/sweetspot/blob/development/docs/CODE_REVIEW.md#p3.21) database.Connect uses log.Printf, not slog
...
### [P3.22](https://github.com/jojianya/sweetspot/blob/development/docs/CODE_REVIEW.md#p3.22) server/deployments/k8s/ is an empty tracked directory
