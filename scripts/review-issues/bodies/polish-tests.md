...
### [P3.17](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.17) Missing Go tests for most modules
...
### [P3.18](https://github.com/jojianya/sweetspot/blob/development/CODE_REVIEW.md#p3.18) CI never runs go test -race
